...
func (x *MovieDeatils) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MovieDeatils) ProtoMessage() {}

func (x *MovieDeatils) ProtoReflect() protoreflect.Message {
	mi := &file_movie_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MovieDeatils.ProtoReflect.Descriptor instead.
func (*MovieDeatils) Descriptor() ([]byte, []int) {
	return file_movie_proto_rawDescGZIP(), []int{1}
}

func (x *MovieDeatils) GetRating() float32 {
	if x != nil {
		return x.Rating
	}
	return 0
...
func (x *MovieDeatils) GetMetadata() *Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_movie_proto_rawDesc = []byte{
	...
	0x0c, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x44, 0x65, 0x61, 0x74, 0x69, 0x6c, 0x73, 0x12, 0x16, 0x0a,
...
var file_movie_proto_goTypes = []interface{}{
	...
	(*MovieDeatils)(nil), // 1: MovieDeatils
}
var file_movie_proto_depIdxs = []int32{
	0, // 0: MovieDeatils.metadata:type_name -> Metadata
